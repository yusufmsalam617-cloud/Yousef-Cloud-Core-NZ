...
cout<<"enter your choice (1 or 2).  " <<endl;
cin>>locationChoice;
double finalPrice =calculateTotal(durationChoice , tierChoice , locationChoice , totalServers);
double taxValue = finalPrice*0.15;
double grandTotal = finalPrice+taxValue;
int bonusServers = totalServers/15;
int finalUnits = totalServers+bonusServers;
cout<<"EnterPrise Name: "<<enterpriseName <<endl;
cout<<"servers number: "<<totalServers <<endl;
cout<<"you got bouns"<<bonusServers <<endl;
